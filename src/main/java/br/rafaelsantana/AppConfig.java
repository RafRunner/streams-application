...
public class AppConfig {
    ...
    public static final Integer DEFAULT_TIMEOUT_REQUESTS = Integer.parseInt(ENV.get("DEFAULT_TIMEOUT_REQUESTS", "15000")); // Milliseconds
    // 10 MiB
    public static final Integer DEFAULT_CACHE_MAX_SIZE = Integer.parseInt(ENV.get("DEFAULT_CACHE_MAX_SIZE", "10485760"));  // Bytes
    public static final Integer DEFAULT_CACHE_MAX_AGE = Integer.parseInt(ENV.get("DEFAULT_CACHE_MAX_AGE", "1800")); // Seconds
    ...
    public static final Integer DEFAULT_TIMEOUT_KAFKA = Integer.parseInt(ENV.get("DEFAULT_TIMEOUT_KAFKA", "15000")); // Milliseconds
